							...
							<div class="card">
								<div class="card-body">
									<form class="forms-sample" enctype="multipart/form-data"
										method="post" action="AdminUpdateExaminationController">
										<input type="hidden" name="examinationId"
											value="${ examinationData.examinationId}" />
										<div class="form-group">
											<label for="name">Name</label> <input name="name"
												value="${examinationData.name }" type="text"
												class="form-control" id="exampleInputName1"
												placeholder="Name examination">
										</div>
										<div class="form-group">
											<label>Level</label> <select class="form-control w-25"
												name="level">
										...
										<div class="form-group">
											<label>Upload data</label> <input type="file"
												name="excelFile" class="file-upload-default">
											<div class="input-group col-xs-12">
												<input type="text" class="form-control file-upload-info"
