		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="row">
						<a class="my-4 text-black" href="AdminCreateExaminationController">Create
							new Examination</a>
														...
														<td class="d-flex align-items-center"><a
															...
															<form id="deleteForm" method="post"
																...
																<button type="button" class="btn " data-toggle="modal"
																	data-target="#exampleModal-${item.examinationId }">
																	<i style="font-size: 30px;"
																		class="mdi mdi-delete-forever btn-icon "></i>
																</button>
																<div class="modal fade"
																	id="exampleModal-${item.examinationId }" tabindex="-1"
						...
						<c:if test="${numberPage == 1 }">
							<div class="btn-group" role="group" aria-label="Basic example">
								...
								<button type="button" class="btn btn-outline-secondary">
									<a href="AdminExaminationController?pageId=1">1</a>
								</button>
								<button type="button" class="btn btn-outline-secondary">
									<a href="AdminExaminationController?pageId=2">2</a>
								</button>
								<button type="button" class="btn btn-outline-secondary">
									<a href="AdminExaminationController?pageId=3">3</a>
								</button>
								<button type="button" class="btn btn-outline-secondary">
									<a href="AdminExaminationController?pageId=${numberPage +1}">Next</a>
								</button>
							</div>
						</c:if>
						<c:if test="${numberPage == maxPageId }">
							<div class="btn-group" role="group" aria-label="Basic example">
								<button type="button" class="btn btn-outline-secondary">
									<a href="AdminExaminationController?pageId=${numberPage - 1 }">Prev</a>
								</button>
								<button type="button" class="btn btn-outline-secondary">
									<a href="AdminExaminationController?pageId=1">1</a>
								</button>
