...
<body>
	...
	<div style="height: 100vh" class="container ">
		<div class="row align-items-center mt-3">
			<!-- <h4>Create new grammar</h4> -->
			<div class="col-12 mt-2">
				<!-- use method post, because method get has limits of the max length -->
				<form class="forms-sample" enctype="multipart/form-data"
					method="post" action="AdminCreateGrammarController" id="myForm">
					...
					<div class="form-group">
						<label>File upload</label> <input type="file" name="file" required
					...
					<div class="form-group">
						<label>Level</label> <select class="form-control w-25"
							...
							<c:forEach items="${ listLevel}" var="item">
								<option value="${item.idLevel }">${item.name }</option>
							</c:forEach>
						</select>
