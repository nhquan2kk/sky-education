		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="row">
						<a class="my-4 text-black" href="AdminCreateGrammarController">Create
							new grammar</a>
											...
											<tbody>
												<c:forEach items="${ listGrammar}" var="item">
													<tr>
														...
														<td><img src="img/grammar/${item.image}" /></td>
														<td class="d-flex align-items-center"><a
															href="AdminUpdateGrammarController?grammarId=${item.grammarId }">
																<i class="mdi mdi-table-edit btn-icon"></i>
														</a>
															<form id="deleteForm" method="post"
																action="AdminDeleteGrammarController">
																<input type="hidden" name="grammarId"
																	value="${item.grammarId }" />
																<button type="button" class="btn " data-toggle="modal"
																	data-target="#exampleModal-${item.grammarId }">
																	<i style="font-size: 30px;"
																		class="mdi mdi-delete-forever btn-icon "></i>
																</button>
																<div class="modal fade"
																	id="exampleModal-${item.grammarId }" tabindex="-1"
						...
						<c:if test="${numberPage == maxPageId }">
							<div class="btn-group" role="group" aria-label="Basic example">
								<button type="button" class="btn btn-outline-secondary">
									<a href="AdminGrammarController?pageId=${numberPage - 1 }">Prev</a>
								</button>
								<button type="button" class="btn btn-outline-secondary">
									<a href="AdminGrammarController?pageId=1">1</a>
								</button>
