<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<head>
			...
			<link href="Assets/Main/lib/lightbox/css/lightbox.min.css" rel="stylesheet">
		...
		<body>
			<div class="position-fixed bottom-0 start-0 p-3" style="z-index: 11">
				<div id="myToastEl" class="toast hide bg-primary" role="alert" aria-live="assertive" aria-atomic="true">
					...
					<div class="row">
						<div class="col-lg-7 mb-5">
							<div class="contact-form">
								...
								<form action="ContactController" novalidate="novalidate" method="post">
