		...
		<div class="container">
			<div class="text-center pb-2">
				<p class="section-title px-5">
					<span class="px-2">Vocabulary</span>
				</p>
			<!-- 	<h1 class="mb-4">Latest Articles From Blog</h1> -->
			</div>
			<div class="row pb-3">
				<c:forEach items="${vocabularysList }" var="item">
					<div class="col-lg-4 mb-4">
						<div class="card border-0 shadow-sm mb-2">
							<img class="card-img-top mb-2" src="img/vocabulary/${item.image }" alt="" style="height : 200px">
							<div class="card-body bg-light text-center p-4">
								<h4 class="">${item.name }</h4>
								<div class="d-flex justify-content-center mb-3">
									<small class="mr-3"><i class="fa fa-user text-primary"></i>
										Admin</small> <small class="mr-3"><i
										class="fa fa-folder text-primary"></i> Vocabulary</small> <small
										class="mr-3">
								...
								<a href="DetailVocabularyController?vocabularyId=${item.vocabularyId }"
					...
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center mb-0">
							<c:if test="${numberPage == 1 }">
								...
								<li class="page-item active"><a class="page-link" href="VocabularyController?pageId=1">1</a></li>
								<li class="page-item"><a class="page-link" href="VocabularyController?pageId=2">2</a></li>
								<li class="page-item"><a class="page-link" href="VocabularyController?pageId=3">3</a></li>
								<li class="page-item"><a class="page-link" href="VocabularyController?pageId=${numberPage + 1 }"
							...
							<c:if test="${numberPage == maxPageId }">
								<li class="page-item "><a class="page-link"
									href="VocabularyController?pageId=${numberPage - 1 }" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										<span class="sr-only">Previous</span>
								</a></li>
								<li class="page-item "><a class="page-link" href="VocabularyController?pageId=1">1</a></li>
								<li class="page-item"><a class="page-link" href="VocabularyController?pageId=2">2</a></li>
								<li class="page-item"><a class="page-link" href="VocabularyController?pageId=3">3</a></li>
							...
							<c:if test="${numberPage != 1 && numberPage < maxPageId }">
								...
								<li class="page-item active"><a class="page-link" href="VocabularyController?pageId=">1</a></li>
								<li class="page-item"><a class="page-link" href="VocabularyController?pageId=2">2</a></li>
								<li class="page-item"><a class="page-link" href="VocabularyController?pageId=3">3</a></li>
								<li class="page-item"><a class="page-link" href="VocabularyController?page=${numberPage + 1 }"
									aria-label="Next"> <span aria-hidden="true">&raquo;</span>
										<span class="sr-only">Next</span>
								</a></li>
							</c:if>
