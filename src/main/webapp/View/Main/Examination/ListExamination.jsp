		...
		<div class="container">
			<div class="text-center pb-2">
				<p class="section-title px-5">
					<span class="px-2">Examination</span>
				</p>
							...
							<div class="card-body bg-light text-center p-4">
								...
								<div class="d-flex justify-content-center mb-3">
									<small class="mr-3"><i class="fa fa-user text-primary"></i>
										Admin</small> <small class="mr-3">Level : ${item.nameLevel}</small> 
										<!-- <small
								...
								<a href="DetailExaminationController?examinationId=${item.examinationId }"
									class="btn btn-primary px-4 mx-auto my-2">Take test</a>
							</div>
						</div>
					</div>
				</c:forEach>
					...
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center mb-0">
							<c:if test="${numberPage == 1 }">
								...
								<li class="page-item active"><a class="page-link" href="ExaminationController?pageId=1">1</a></li>
								<li class="page-item"><a class="page-link" href="ExaminationController?pageId=2">2</a></li>
								<li class="page-item"><a class="page-link" href="ExaminationController?pageId=3">3</a></li>
								<li class="page-item"><a class="page-link" href="ExaminationController?pageId=${numberPage + 1 }"
							...
							<c:if test="${numberPage == maxPageId }">
								<li class="page-item "><a class="page-link"
									href="ExaminationController?pageId=${numberPage - 1 }" aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
										<span class="sr-only">Previous</span>
								</a></li>
								<li class="page-item "><a class="page-link" href="ExaminationController?pageId=1">1</a></li>
								<li class="page-item"><a class="page-link" href="ExaminationController?pageId=2">2</a></li>
								<li class="page-item"><a class="page-link" href="ExaminationController?pageId=3">3</a></li>
							...
							<c:if test="${numberPage != 1 && numberPage < maxPageId }">
								...
								<li class="page-item active"><a class="page-link" href="ExaminationController?pageId=">1</a></li>
								<li class="page-item"><a class="page-link" href="ExaminationController?pageId=2">2</a></li>
								<li class="page-item"><a class="page-link" href="ExaminationController?pageId=3">3</a></li>
								<li class="page-item"><a class="page-link" href="ExaminationController?page=${numberPage + 1 }"
									aria-label="Next"> <span aria-hidden="true">&raquo;</span>
										<span class="sr-only">Next</span>
								</a></li>
							</c:if>
