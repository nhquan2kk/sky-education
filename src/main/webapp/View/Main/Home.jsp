	...
	<div class="container-fluid bg-primary px-0 px-md-5 mb-5">
		<div class="row align-items-center px-3">
			<div class="col-lg-6 text-center text-lg-left">
				...
				<h1 class="display-3 font-weight-bold text-white">Free English test with new topics every day</h1>
				<p class="text-white mb-4">Latest exam bank with 200+ sets
topics, 10,000+ questions, detailed results and answers</p>
				<a href="" class="btn btn-secondary mt-1 py-3 px-5">Read more</a>
			</div>
			<div class="col-lg-6 text-center text-lg-right">
				<img class="img-fluid mt-5" src="Assets/Main/img/header.png" alt="">
			</div>
		</div>
	</div>
	<!-- Header End -->
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 pb-1">
					<div class="d-flex bg-light shadow-sm border-top rounded mb-4"
						style="padding: 30px;">
						<img style="width: 100%" src="Assets/Main/img/graduation-hat.png"/>
						<i
			...
			<div class="row align-items-center">
				<div class="col-lg-5">
					<img class="img-fluid rounded mb-5 mb-lg-0"
						src="Assets/Main/img/about-1.jpg" alt="">
				</div>
				<div class="col-lg-7">
					...
					<div class="row pt-2 pb-4">
						<div class="col-6 col-md-4">
							<img class="img-fluid rounded" src="Assets/Main/img/about-2.jpg"
								alt="">
						</div>
			...
			<div class="row">
				<div class="col-md-6 col-lg-3 text-center team mb-5">
					<div class="position-relative overflow-hidden mb-4"
						...
						<img class="img-fluid w-100" src="Assets/Main/img/team-1.jpg"
							alt="">
						<div
				...
				<div class="col-md-6 col-lg-3 text-center team mb-5">
					<div class="position-relative overflow-hidden mb-4"
						style="border-radius: 100%;">
						<img class="img-fluid w-100" src="Assets/Main/img/team-2.jpg"
							alt="">
						<div
							class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
							<a class="btn btn-outline-light text-center mr-2 px-0"
				...
				<div class="col-md-6 col-lg-3 text-center team mb-5">
					<div class="position-relative overflow-hidden mb-4"
						style="border-radius: 100%;">
						<img class="img-fluid w-100" src="Assets/Main/img/team-3.jpg"
							alt="">
						<div
							class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
							<a class="btn btn-outline-light text-center mr-2 px-0"
				...
				<div class="col-md-6 col-lg-3 text-center team mb-5">
					<div class="position-relative overflow-hidden mb-4"
						style="border-radius: 100%;">
						<img class="img-fluid w-100" src="Assets/Main/img/team-4.jpg"
							alt="">
						<div
							class="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
							<a class="btn btn-outline-light text-center mr-2 px-0"
	...
	<div class="container-fluid py-5">
		<div class="container p-0">
			<div class="text-center pb-2">
				...
				<h1 class="mb-4">What Peoples Say!</h1>
			</div>
...
What I like most about this platform is that it corrects the lessons very carefully, providing a variety of courses to suit each learner's needs with deadlines to motivate students to study.
					</div>
					<div class="d-flex align-items-center">
						<img class="rounded-circle"
							src="Assets/Main/img/testimonial-1.jpg"
				...
				<div class="testimonial-item px-3">
					<div class="bg-light shadow-sm rounded mb-4 p-4">
						<h3 class="fas fa-quote-left text-primary mr-3"></h3>
						I live in the suburbs, so it is difficult to go to direct teaching centers, online courses are also quite expensive, so when I learned about the English background of my teacher, I was very happy and surprised at the quality that I received. it brings. Free but of very high quality, the exam questions have detailed explanations, many additional documents are provided to help learners expand their knowledge.
					</div>
					<div class="d-flex align-items-center">
						<img class="rounded-circle"
							src="Assets/Main/img/testimonial-2.jpg"
							style="width: 70px; height: 70px;" alt="Image">
						<div class="pl-3">
							<h5>People Name</h5>
							<i>Profession</i>
				...
				<div class="testimonial-item px-3">
					<div class="bg-light shadow-sm rounded mb-4 p-4">
						<h3 class="fas fa-quote-left text-primary mr-3"></h3>
					Due to my busy school schedule and part-time job, my time to study TOEIC is quite limited. When learning on the basis of Mr. Quy, I can do mini tests, short question types to help me learn more effectively. At the end of the week, I will have a lot of time to do fulltest tests to evaluate my real ability, the website edits the articles very carefully, emphasizing the key points that are often encountered in the exam.
					</div>
					<div class="d-flex align-items-center">
						<img class="rounded-circle"
							src="Assets/Main/img/testimonial-3.jpg"
							style="width: 70px; height: 70px;" alt="Image">
						<div class="pl-3">
							<h5>People Name</h5>
							<i>Profession</i>
...
What I like most about this platform is that it corrects the lessons very carefully, providing a variety of courses to suit each learner's needs with deadlines to motivate students to study.
					...
					<div class="d-flex align-items-center">
						<img class="rounded-circle"
							src="Assets/Main/img/testimonial-4.jpg"
							style="width: 70px; height: 70px;" alt="Image">
						<div class="pl-3">
							<h5>People Name</h5>
							<i>Profession</i>
	...
	<div class="container-fluid pt-5">
		<div class="container">
			<div class="text-center pb-2">
				<p class="section-title px-5">
					<span class="px-2">Grammar blog</span>
				</p>
				<h1 class="mb-4">New grammar blog</h1>
			</div>
			<div class="row pb-3">
				<c:forEach items="${grammarList }" var="item">
				<div class="col-lg-4 mb-4">
					<div class="card border-0 shadow-sm mb-2">
						<img class="card-img-top mb-2" src="img/grammar/${item.image }" style="height : 200px"
							alt="">
						<div class="card-body bg-light text-center p-4">
							...
							<a href="DetailGrammarController?grammarId=${item.grammarId }" class="btn btn-primary px-4 mx-auto my-2">Read
								More</a>
						</div>
					</div>
				</div>
