...
public class ReadingQuiz {
	...
	public int getReadingQuizId() {
		return readingQuizId;
	}
	public void setReadingQuizId(int readingQuizId) {
		this.readingQuizId = readingQuizId;
	}
